...
const ManageSubAdminsDialog = ({ open, onClose }) => {
  ...
  const fetchUsers = async () => {
    ...
    try {
      ...
      const res = await fetch("https://production-engineering-inventory-g18j.onrender.com/api/users", {
        headers: {
  ...
  const createSubAdmin = async () => {
    ...
    try {
      ...
      const res = await fetch("https://production-engineering-inventory-g18j.onrender.com/api/users/subadmin", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`
  ...
  const promoteToAdmin = async (id) => {
    ...
    try {
      ...
      await fetch(`https://production-engineering-inventory-g18j.onrender.com/api/users/promote/${id}`, {
        method: "PATCH",
        headers: {
          Authorization: `Bearer ${token}`
        }
